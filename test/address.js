...
var npwcore = require('..');
var PublicKey = npwcore.PublicKey;
var Address = npwcore.Address;
var Script = npwcore.Script;
var Networks = npwcore.Networks;

var validbase58 = require('./data/npwd/base58_keys_valid.json');
var invalidbase58 = require('./data/npwd/base58_keys_invalid.json');

describe('Address', function() {

  var pubkeyhash = new Buffer('3c3fa3d4adcaf8f52d5b1843975e122548269937', 'hex');
  var buf = Buffer.concat([new Buffer('35', 'hex'), pubkeyhash]);
  var str = 'NRQXy3jhLWQgJe2sYWvdeW6viZnVFRYmG4';
  ...
  describe('npwd compliance', function() {
    validbase58.map(function(d) {
      if (!d[2].isPrivkey) {
        it('should describe address ' + d[0] + ' as valid', function() {
          ...
          // var addrhash = new Buffer(d[1], 'hex');
          // var buf = Buffer.concat([new Buffer(Networks.get(network)[type].toString(16), 'hex'), addrhash]);
          // console.log(Address(buf, network, type).toString());
  ...
  // livenet valid
  var PKHLivenet = [
    'NQqio5TPJjaVHJZNraRVCYnR5DsbeGTWNo',
    'NV1t4mgnR3PSnCnvf5inas7iRgGb5SNXhi',
    'NWja1R8uAgMcn84uQosRPZnPCjsPaFDZwG',
    'Ndu19xDti11TA1558UpyeWs72NR3Q16jyL',
    '    Ndu19xDti11TA1558UpyeWs72NR3Q16jyL   \t\n'
  ];

  // livenet p2sh
  var P2SHLivenet = [
    '6GjVmJoWbgzfk7MwPGecqwmwspHUnHyZQY',
    '6Gdi1N6amBarYUBrU7AeVEwY2BRNfiJbRD',
    '6L9dyJJMeWTWAUu6Cf9dhg1peeLvhmMYTY',
    '6dSNQZr4cMS9NrhDUp84U682ZjhQyECmLM',
    '\t \n6dSNQZr4cMS9NrhDUp84U682ZjhQyECmLM \r'
  ];
  ...
  var badChecksums = [
    'NQqio5TPJjaVHJZNraRVCYnR5DsbxeTWNo',
    'NV1t4mgnR3PSnCnvf5inas7iRgxt5SNXhi',
    'NWja1R8uAgMcn84uaxsRPZnPCjsPaFDZwG',
    'Ndu19xDti11TA1558Ux2eWs72NR3Q16jyL'
  ];

  //livenet non-base58
  var nonBase58 = [
    'NQqio5TPJj#VHJZNraRVCY$R5DsbeGTWNo',
    'NV104mgnR3PSnCnvf5inas7iRgGb5SNXhi',
    'NWja1R8uAgMcn84uIosRPZnPCjsPaFDZwG',
    'Ndu19xDtO11TA1558UpyeWs72NR3Q16jyL'
  ];

  //testnet valid
  var PKHTestnet = [
    'yHbKc8Eu7QaR14H1JrUztZPak3rC4aKP7C',
    'yKYqcTNzunYy6Dvc3KUHDopefakNaSMWaZ',
    'yBKknYJuFTkJqeBatZg54oZX7ZssVZM2Ah',
    'y9z2MRudWM79wYGm73LisyLGL9Jrbfzf11'
  ];

  describe('validation', function() {

    it('getValidationError detects network mismatchs', function() {
      var error = Address.getValidationError('6KtQahpAwHsdbJTQZjbtFVDTYPUks6NwQU', 'testnet');
      should.exist(error);
    });

    it('isValid returns true on a valid address', function() {
      var valid = Address.isValid('6KtQahpAwHsdbJTQZjbtFVDTYPUks6NwQU', 'livenet');
      valid.should.equal(true);
    });

    it('isValid returns false on network mismatch', function() {
      var valid = Address.isValid('6KtQahpAwHsdbJTQZjbtFVDTYPUks6NwQU', 'testnet');
    ...
    it('addresses with whitespace are validated correctly', function() {
      ...
      should.not.exist(error);
      Address.fromString(ws).toString().should.equal('NV1t4mgnR3PSnCnvf5inas7iRgGb5SNXhi');
    });
  });
  ...
  describe('encodings', function() {
    ...
    it('should error because of unrecognized data format', function() {
      ...
      }).should.throw(npwcore.errors.InvalidArgument);
    });
    ...
    it('should make this address from a compressed pubkey', function() {
      ...
      address.toString().should.equal('NUbFGfW7AemmCs94PL3mG2uFzj7cicFKhc');
    });
    ...
    it('should make this address from an uncompressed pubkey', function() {
      ...
      a.toString().should.equal('NRDVyTkzw3GQ1xLfGKvxZu3fDRY8XYQjAs');
      var b = new Address(pubkey, 'livenet', 'pubkeyhash');
      b.toString().should.equal('NRDVyTkzw3GQ1xLfGKvxZu3fDRY8XYQjAs');
    });
    ...
    describe('from a script', function() {
      ...
      it('should make this address from a p2pkh output script', function() {
        ...
        a.toString().should.equal('NeE7zjrrsqh3MrUw4xLazEE8b1c344LQgY');
        var b = new Address(s, 'livenet');
        b.toString().should.equal('NeE7zjrrsqh3MrUw4xLazEE8b1c344LQgY');
      });
      ...
      it('should make this address from a p2sh input script', function() {
        ...
        var a = Address.fromScript(s, 'livenet');
        a.toString().should.equal('6VcUEeVAaxCfwvUkifqp7bNtJNzy5zhm3a');
        var b = new Address(s, 'livenet');
        b.toString().should.equal('6VcUEeVAaxCfwvUkifqp7bNtJNzy5zhm3a');
      });

      it('returns the same address if the script is a pay to public key hash out', function() {
        var address = 'NUbFGfW7AemmCs94PL3mG2uFzj7cicFKhc';
      ...
      it('returns the same address if the script is a pay to script hash out', function() {
        var address = '6VcUEeVAaxCfwvUkifqp7bNtJNzy5zhm3a';
  ...
  describe('#toBuffer', function() {
    ...
    it('3c3fa3d4adcaf8f52d5b1843975e122548269937 corresponds to hash NRQXy3jhLWQgJe2sYWvdeW6viZnVFRYmG4', function() {
      var address = new Address(str);
  ...
  describe('#object', function() {
    ...
    it('will fail with invalid state', function() {
      ...
      }).to.throw(npwcore.errors.InvalidState);
    });
  });
  ...
  describe('#inspect', function() {
    it('should output formatted output correctly', function() {
      var address = new Address(str);
      var output = '<Address: NRQXy3jhLWQgJe2sYWvdeW6viZnVFRYmG4, type: pubkeyhash, network: livenet>';
  ...
  describe('creating a P2SH address from public keys', function() {
    ...
    it('can create an address from a set of public keys', function() {
      ...
      address.toString().should.equal('6UbfGJ7ANqdsCatBfoRXZyjNWwriGWiVer');
    ...
    it('can create an address from a set of public keys with a nested witness program', function() {
      ...
      address.toString().should.equal('6cX8tTa9AD6KasD6ao8rzBajb3GuAdqosw');
    });
