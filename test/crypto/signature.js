...
var JSUtil = npwcore.util.js;
var Interpreter = npwcore.Script.Interpreter;

var sig_canonical = require('../data/npwd/sig_canonical');
var sig_noncanonical = require('../data/npwd/sig_noncanonical');
...
describe('Signature', function() {
  ...
  describe('@isTxDER', function() {
    ...
    describe('npwd fixtures', function() {
