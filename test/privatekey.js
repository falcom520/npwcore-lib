...
var Point = npwcore.crypto.Point;
...
describe('PrivateKey', function() {
  ...
  var wifLivenet = 'YSyixc1t11KZusikMeDY6Tq4WxifScGRtPJxCafezLvciPa4rK3Y';
  var wifLivenetUncompressed = '88FDE3x2azAeN3Rs9kmytY11oDAtks8aHB3FmmLBRKZYCjyprLj';
  ...
  it('should create a private key from WIF string', function() {
    var a = new PrivateKey('YU9ytZj764mXYkw4988MfvCBhD7Ut4oNNpKz8nDNHAbvts7GiCBK');
    should.exist(a);
    should.exist(a.bn);
  });

  it('should create a private key from WIF buffer', function() {
    var a = new PrivateKey(Base58Check.decode('YU9ytZj764mXYkw4988MfvCBhD7Ut4oNNpKz8nDNHAbvts7GiCBK'));
    should.exist(a);
    should.exist(a.bn);
  });
    ...
    validbase58.map(function(d){
      if (d[2].isPrivkey) {
        it('should instantiate WIF private key ' + d[0] + ' with correct properties', function() {
          ...
          var pri = new Buffer(d[1], 'hex');
          var buf = Buffer.concat([new Buffer(network['privatekey'].toString(16), 'hex'), pri]);
          console.log(new PrivateKey(buf).toWIF());
  ...
  describe('instantiation', function() {
    ...
    it('should not be able to instantiate private key because of network mismatch', function() {
      expect(function() {
        return new PrivateKey('YU9ytZj764mXYkw4988MfvCBhD7Ut4oNNpKz8nDNHAbvts7GiCBK', 'testnet');
      }).to.throw('Private key network mismatch');
    });

    it('should not be able to instantiate private key WIF is too long', function() {
      expect(function() {
        var buf = Base58Check.decode('YU9ytZj764mXYkw4988MfvCBhD7Ut4oNNpKz8nDNHAbvts7GiCBK');
  ...
  describe('#toAddress', function() {
    it('should output this known livenet address correctly', function() {
      var privkey = PrivateKey.fromWIF('YU9ytZj764mXYkw4988MfvCBhD7Ut4oNNpKz8nDNHAbvts7GiCBK');
      var address = privkey.toAddress();
      address.toString().should.equal('NV1t4mgnR3PSnCnvf5inas7iRgGb5SNXhi');
    });
  ...
  describe('#getValidationError', function(){
    ...
    it('should validate as true', function() {
      var a = PrivateKey.isValid('YU9ytZj764mXYkw4988MfvCBhD7Ut4oNNpKz8nDNHAbvts7GiCBK');
      a.should.equal(true);
    });
  ...
  describe('#toPublicKey', function() {
    ...
    it('should convert this known PrivateKey to known PublicKey and preserve compressed=true', function() {
      var privwif = 'YU9ytZj764mXYkw4988MfvCBhD7Ut4oNNpKz8nDNHAbvts7GiCBK';
  ...
  it('creates an address as expected from WIF, livenet', function() {
    var privkey = new PrivateKey('87JuMkaZtQvbdK45XdgkBb9JzmAyrn75b9qDqW527pyqfFbdBCU');
    privkey.publicKey.toAddress().toString().should.equal('NMza8fUWqLGCiSS2wSXCM7Gd9p9idZmtbs');
  });
  ...
  it('creates an address as expected from WIF, testnet', function() {
    ...
    privkey.publicKey.toAddress().toString().should.equal('y5B4VNpzt9pDm5bfxYLZoJ9JpA9oJnrgEn');
  });
