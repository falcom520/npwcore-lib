...
var npwcore = require('../..');
var UnspentOutput = npwcore.Transaction.UnspentOutput;

describe('UnspentOutput', function() {

  var sampleData1 = {
    'address': 'y9TSQY8uCrPUxsWtK3rtWpnkVzSTByCvey',
  ...
  var sampleData2 = {
    ...
    'vout': 1,
    'address': 'xwe5sDDzsjRZjWH5Dd89nBew1T4tr3eJn9',
  ...
  it('displays nicely on the console', function() {
    var expected = '<UnspentOutput: a477af6b2667c29670467e4e0728b685ee07b240235771862318e29ddbe58458:0' +
                   ', satoshis: 1020000, address: y9TSQY8uCrPUxsWtK3rtWpnkVzSTByCvey>';
