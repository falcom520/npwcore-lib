...
describe('Script', function() {
  ...
  describe('#isPublicKeyIn', function() {
    it('correctly identify scriptSig as a public key in', function() {
      ...
      var script = npwcore.Script.fromBuffer(scriptBuffer);
  ...
  describe('#isPushOnly', function() {
    it('should know these scripts are or aren\'t push only', function() {
      ...
      // like npwd, we regard OP_RESERVED as being "push only"
  ...
  describe('#buildWitnessMultisigOutFromScript', function() {
    it('it will build nested witness scriptSig', function() {
      var redeemScript = npwcore.Script();
      var redeemHash = npwcore.crypto.Hash.sha256(redeemScript.toBuffer());
  ...
  describe('#buildPublicKeyHashOut', function() {
    it('should create script from livenet address', function() {
      ...
      s.toAddress().toString().should.equal('NhVRghKUr2s1sBoB33E34UiQLoZTdDvugq');
    });
    it('should create script from testnet address', function() {
      var address = Address.fromString('yDtFfCkNTGgcKEECc6uAM4tffuHrVPACCj');
      var s = Script.buildPublicKeyHashOut(address);
      should.exist(s);
      s.toString().should.equal('OP_DUP OP_HASH160 20 0xb96b816f378babb1fe585b7be7a2cd16eb99b3e4 OP_EQUALVERIFY OP_CHECKSIG');
      s.isPublicKeyHashOut().should.equal(true);
      s.toAddress().toString().should.equal('yDtFfCkNTGgcKEECc6uAM4tffuHrVPACCj');
    });
  ...
  describe('#buildPublicKeyOut', function() {
    it('should create script from public key', function() {
      var pubkey = new PublicKey('032df8750480ad5b26950b25c7ba79d3e37d75f640f8e5d9bcd5b150a0f85014da');
      var s = Script.buildPublicKeyOut(pubkey);
      should.exist(s);
      s.toString().should.equal('33 0x032df8750480ad5b26950b25c7ba79d3e37d75f640f8e5d9bcd5b150a0f85014da OP_CHECKSIG');
  ...
  describe('#buildScriptHashOut', function() {
    ...
    it('inherits network property from other script', function() {
      var s1 = new Script.fromAddress(new Address('NaMKhWXm1jXRpM8CFgivWhCBfvo6h8errS'));
    ...
    it('inherits network property form an address', function() {
      var address = new Address('6H5c1sxkx2BMNyzFvGTQ4PUHHDHQDfWpYk');
  ...
  describe('getData returns associated data', function() {
    ...
    it('for a P2SH address', function() {
      var address = Address.fromString('6VQiEdYuCJBfe1FcRKSh7TMJ6TA2rTCyrf');
  ...
  describe('toAddress', function() {
    ...
    it('for a P2PKH address', function() {
      var stringAddress = 'NhVRghKUr2s1sBoB33E34UiQLoZTdDvugq';
      var address = new Address(stringAddress);
      var script = new Script(address);
      script.toAddress().toString().should.equal(stringAddress);
    });
    it('for a P2SH address', function() {
      var stringAddress = '6VQiEdYuCJBfe1FcRKSh7TMJ6TA2rTCyrf';
      var address = new Address(stringAddress);
      var script = new Script(address);
      script.toAddress().toString().should.equal(stringAddress);
    });
    ...
    it('works for p2pkh output', function() {
      ...
      script.toAddress().toString().should.equal('NeE7zjrrsqh3MrUw4xLazEE8b1c344LQgY');
    });
    it('works for p2pkh input', function() {
      ...
      var s2 = new Script('71 0x3044022017053dad84aa06213749df50a03330cfd24d6b8e7ddbb6de66c03697b78a752a022053bc0faca8b4049fb3944a05fcf7c93b2861734d39a89b73108f605f70f5ed3401 33 0x0325386e988b84248dc9c30f784b06e02fdec57bbdbd443768eb5744a75ce44a4c');
      s2.toAddress().toString().should.equal('NaBY1JeQWoAfkxXptcb4Gn5WsF4venjMTu');
    });
    ...
    it('works for p2sh output', function() {
      ...
      script.toAddress().toString().should.equal('6URBRzGCH6z33jBzbTsGo12Yq9FnVhLmhK');
    });
    it('works for p2sh input', function() {
      ...
      script.toAddress().toString().should.equal('6VFYVGLWcK2w8mtFZXrCPkNLeNxoyQp5G7');
    });
  ...
  describe('#getSignatureOperationsCount', function() {
    // comes from npwd src/test/sigopcount_tests
    ...
    it('should handle P2SH-multisig-in scripts from utility', function() {
      ...
      var signature = npwcore.crypto.Signature.fromString('30060201FF0201FF');
