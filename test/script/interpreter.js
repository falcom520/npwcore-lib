...
var script_tests = require('../data/npwd/script_tests');
var tx_valid = require('../data/npwd/tx_valid');
var tx_invalid = require('../data/npwd/tx_invalid');

//the script string format used in npwd data tests
Script.fromNpwdString = function(str) {
...
describe('Interpreter', function() {
  ...
  describe('#verify', function() {
    ...
    it('should verify these simple transaction', function() {
      ...
      var toAddress = 'y9TSQY8uCrPUxsWtK3rtWpnkVzSTByCvey';
  ...
  var testFixture = function(vector, expected, witness, amount) {
    var amount = amount || 0;
    var scriptSig = Script.fromNpwdString(vector[0]);
    var scriptPubkey = Script.fromNpwdString(vector[1]);
  ...
  describe('npwd script evaluation fixtures', function() {
  ...
  describe('npwd transaction evaluation fixtures', function() {
      ...
      set.forEach(function(vector) {
        ...
        it('should pass tx_' + (expected ? '' : 'in') + 'valid vector ' + cc, function() {
          ...
          inputs.forEach(function(input) {
            ...
            if (txoutnum === -1) {
              txoutnum = 0xffffffff; //npwd casts -1 to an unsigned int
            }
            map[txid + ':' + txoutnum] = Script.fromNpwdString(scriptPubKeyStr);
          });
