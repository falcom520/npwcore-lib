...
describe('PublicKey', function() {
  ...
  describe('instantiation', function() {
    ...
    it('problematic secp256k1 public keys', function() {
      ...
      var knownKeys = [
        {
          wif: 'YRahMPHpCkTTGP9S6eeGmo2z4en2gFD51Ca5P4uhT3Xq8rVzxpK9',
        ...
        {
          wif: 'YW4eUVdjjL4eoePLKApSK5rKA7tPtCUU2Mpc448A2qZbQwb81RQW',
  ...
  describe('hashes', function() {
    ...
    var data = [
      ['87F3kQNbBSLqsTdgCaSh432t5JxUL9v1PMqo4K4bAopHy6ytBnu', 'NjAp27GUhe7vPMgpboYU1rJ78TzSqXW66J'],
      ['88UbUDYuKep6MA6BXjG2c9NkwxGvgUYDY3vxWN4GWXpoQUnqoFM', 'NZzwFysWzAdzLbhUUPMEH84kPzswx2Kb2j'],
      ['YNZ18aAHs4rahiYt26cPnPyJS2FqdYLxhgzNHciqpHdjtHMgLxms', 'NhiH3Zg9awjm1AgVbm6wzE41DG5Dsyo3PK'],
      ['YTzo98PowKtrby7sUdXL67y2yYyHwEYnL3w9zbwRTM3ypLbaMfcU', 'NXLhD3mcdm5xLFZ7deYbxzQP3779BbJg7A']
    ];
