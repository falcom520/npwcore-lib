...
function Address(data, network, type) {
  ...
  if (type && (type !== Address.PayToPublicKeyHash && type !== Address.PayToScriptHash &&
    type !== Address.Coinbase && type !== Address.PayToZeroCoin)) {
...
/** @static */
Address.PayToZeroCoin = 'zerocoin';
/** @static */
...
/**
 * Internal function to transform a npw address buffer
 *
 * @param {Buffer} buffer - An instance of a hex encoded address Buffer
 ...
 *
 * The addresses will be sorted lexicographically, as that is the trend in npw.
...
/**
 * Internal function to transform a npw address string
 *
 * @param {string} data
 * @param {String|Network=} network - either a Network instance, 'livenet', or 'testnet'
 * @param {string=} type - The type: 'pubkeyhash' or 'scripthash'
 ...
 *
 * @param {string} str - An string of the npw address
 * @param {String|Network=} network - either a Network instance, 'livenet', or 'testnet'
 * @param {string=} type - The type of address: 'script' or 'pubkey'
 * @returns {Address} A new valid and frozen instance of an Address
 */
 ...
 *
 * @returns {Buffer} NPW address buffer
 */
Address.prototype.toBuffer = function() {
  if (this.type == Address.Coinbase || this.type == Address.PayToZeroCoin) {
 ...
 *
 * @returns {string} NPW address
 */
Address.prototype.toString = function() {
  if (this.type == Address.Coinbase || this.type == Address.PayToZeroCoin) {
    return this.hashBuffer.toString();
  }
