...
Object.defineProperty(Input.prototype, 'script', {
  ...
  enumerable: true,
  get: function() {
    if (!this._scriptBuffer && this.isNull()) {
      return null;
    }
    if (!this._script) {
...
/**
 * @returns true if this is a zerocoin spend input
 */
Input.prototype.isZerocoinSpend = function() {
  return (this.isNull() && this.script && this.script.isZerocoinSpend());
}
...
Input.prototype.toAddress = function() {
  if (this.isNull() && !this.isZerocoinSpend()) {
    var info = {};
    info.hashBuffer = new Buffer('coinbase');
    info.type = Address.Coinbase;
    return new Address(info);
  } else if (this.script) {
    return this.script.toAddress();
  }
  return null;
};
