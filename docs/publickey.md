# Public Key
Represents a npw public key and is needed to be able to receive NPW, as is usually represented as a npw [Address](address.md). See the official [Bitcoin Wiki](https://en.bitcoin.it/wiki/Technical_background_of_version_1_Bitcoin_addresses).

A PublicKey in Npwcore is an immutable object and can be instantiated from a [Point](crypto.md), string, [PrivateKey](privatekey.md), Buffer or a [BN](crypto.md).
...
> var compressedPK = npwcore.PublicKey('030589ee559348bd6a7325994f9c8eff12bd'+
    '5d73cc683142bd0dd1a17abc99b0dc');
> compressedPK.compressed;
true
> compressedPK.toAddress().toString();
'NeWSUpkQHPYXkpMM4oFMJi5oW3FW9VE46X'
// compressed public key starting with 0x02 (smaller than midpoint of curve)
> var compressedPK2 = new npwcore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = npwcore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
...
'NZCLkrCKwYbMGLdYdHo1TsUk5VBhiHHYJ1'
```
