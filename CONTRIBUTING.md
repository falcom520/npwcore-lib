Contributing to Npwcore
=======

We're working hard to make *npwcore* the most powerful JavaScript library for working with newpowercoin. Our goal is to have *npwcore* be a library that can be used by anyone interested in newpowercoin, and to level expertise differences with great design and documentation.
...
These are some global design goals in npwcore that any change must adhere.
...
When possible, npwcore objects should have standard methods on an instance prototype:
...
`JSON.stringify` and `JSON.parse` are expected to be handled outside of the scope of Npwcore methods. For example, calling `JSON.stringify` on an Npwcore object will behave as expected and call `transaction.toJSON()` and then stringify it:
...
#### T3 - Require 'npwcore' and Look up Classes from There

This helps to make tests more useful as examples, and more independent of where they are placed. This also helps prevent forgetting to include all submodules in the npwcore object.
...
```sh
git remote add npw-project git@github.com:npw-project/npwcore.git
git pull --rebase npw-project master
```
...
```
Finally go to [github.com/npw-project/npwcore](https://github.com/npw-project/npwcore) in your web browser and issue a new pull request.

Main contributors will review your code and possibly ask for changes before your code is pulled in to the main repository.  We'll check that all tests pass, review the coding style, and check for general code correctness. If everything is OK, we'll merge your pull request and your code will be part of npwcore.

If you have any questions feel free to post them to
[github.com/npw-project/npwcore/issues](https://github.com/npw-project/npwcore/issues).
